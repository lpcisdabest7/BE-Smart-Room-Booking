...
2. **Use Memory for Context** — Search for prior implementation notes/patterns before starting: `apero prompt-kit memory search --query "<feature implementation plan>"`.
...
6. **Store Reusable Knowledge** — Save reusable implementation guidance/decisions with `apero prompt-kit memory store ...`.
