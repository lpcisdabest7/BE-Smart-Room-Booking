...
2. **Use Memory for Context** — Search memory for existing testing patterns and prior edge cases: `apero prompt-kit memory search --query "<feature testing strategy>"`.
...
7. **Store Reusable Knowledge** — Save reusable testing patterns or tricky fixtures with `apero prompt-kit memory store ...`.
