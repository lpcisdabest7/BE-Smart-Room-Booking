...
2. **Use Memory for Context** — Search memory for prior knowledge about this module/domain: `apero prompt-kit memory search --query "<entry point or subsystem>"`.
...
7. **Store Reusable Knowledge** — If insights should persist across sessions, store them using `apero prompt-kit memory store ...`.
