...
1. **Use Memory for Context** — Search memory for prior architecture constraints/patterns: `apero prompt-kit memory search --query "<feature design architecture>"`.
2. Summarize:
...
4. **Store Reusable Knowledge** — Persist approved design patterns/constraints with `apero prompt-kit memory store ...` when they will help future work.
