...
2. **Use Memory for Context** — Search memory for established patterns and prior refactors in this area: `apero prompt-kit memory search --query "<component simplification pattern>"`.
...
6. **Store Reusable Knowledge** — Save reusable simplification patterns and trade-offs via `apero prompt-kit memory store ...`.
