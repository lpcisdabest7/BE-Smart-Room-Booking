...
2. **Use Memory for Context** — Search memory for known constraints and prior decisions before assessing mismatches: `apero prompt-kit memory search --query "<feature implementation alignment>"`.
...
5. **Store Reusable Knowledge** — Save recurring alignment lessons/patterns with `apero prompt-kit memory store ...`.
