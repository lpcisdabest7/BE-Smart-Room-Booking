...
2. **Use Memory for Context** — Search memory for project review standards and recurring pitfalls: `apero prompt-kit memory search --query "code review checklist project conventions"`.
...
6. **Store Reusable Knowledge** — Save durable review findings/checklists with `apero prompt-kit memory store ...`.
